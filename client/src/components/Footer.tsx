      ...
      <div className="relative container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-2 ">
            ...
            <p className="text-muted-foreground text-lg mb-8 max-w-md leading-relaxed text-left">
          ...
          <div className="order-2 md:order-none">
            <h4 className="text-lg font-semibold text-foreground mb-6 text-left">
              Solutions
            </h4>
        ...
        <div className="border-t border-border/30 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-2 text-muted-foreground text-sm">
              <span>Built By</span>
              <a className="text-red-500" href="https://www.zenithstudio.in" target="_blank" >Zenith Studio</a>
            </div>
          </div>
        </div>
      </div>
